...
echo "[*] Tag $WAKTU"
# build Docker image dari Dockerfile (name: <username-docker>/karsajobs:latest)
docker build -t ghcr.io/nndakurnia/karsajobs:latest .
...
docker push ghcr.io/nndakurnia/karsajobs:latest
