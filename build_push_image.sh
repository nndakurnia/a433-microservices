...
echo "[*] Tag $WAKTU"
# build Docker image dari Dockerfile (name:order-service, tag:v1)
...
docker image tag order-service:v1  ghcr.io/nndakurnia/order-service:v1
...
docker push ghcr.io/nndakurnia/order-service:v1
