...
echo "[*] Tag $WAKTU"
# build Docker image dari Dockerfile (name:shipping-service, tag:v1)
...
docker image tag shipping-service:v1  ghcr.io/nndakurnia/shipping-service:v1
...
docker push ghcr.io/nndakurnia/shipping-service:v1
